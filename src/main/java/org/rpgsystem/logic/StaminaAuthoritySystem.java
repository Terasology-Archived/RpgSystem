...
public class StaminaAuthoritySystem extends BaseComponentSystem implements UpdateSubscriberSystem {
    private static final Logger logger = LoggerFactory.getLogger(StaminaAuthoritySystem.class);
    ...
    public void update(float delta) {
        ...
        for (EntityRef entity : entityManager.getEntitiesWith(StaminaComponent.class)) {
            ...
            if (SHTUtils.getStaminaForEntity(entity) < stamina.healthLossThreshold) {
    ...
    public void characterMoved(CharacterMoveInputEvent event, EntityRef character, ThirstComponent thirst) {
        ...
        if (expectedDecay != thirst.decayPerSecond) {
